...
from layers import DynamicHyperGraphAttention
...
class Miformer(pl.LightningModule):
    ...
    def configure_optimizers(self):
        ...
        whitelist_weight_modules = (
            ...
            nn.LSTMCell, nn.GRU, nn.GRUCell, DynamicHyperGraphAttention, HypergraphConv
        )
        ...
        assert len(inter_params) == 0, f"Intersection found between decay and no_decay parameters: {inter_params}"
        ...
        assert len(missing_params) == 0, "Some parameters were not categorized in decay or no_decay."
